...
void TrainView::initializeTexture()
{
	...
	QOpenGLTexture* texture = new QOpenGLTexture(QImage("./Textures/colormap.png"));
	Textures.push_back(texture);
	texture = new QOpenGLTexture(QImage("./Textures/PflastergrauSPEC.png"));
	Textures.push_back(texture);
	texture = new QOpenGLTexture(QImage("./Textures/Stump_CU.png"));
	Textures.push_back(texture);
	texture = new QOpenGLTexture(QImage("./Textures/car.png"));
	Textures.push_back(texture);
}
